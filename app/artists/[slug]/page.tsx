...
export default async function ArtistPortfolio({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="portfolio-page">
      <header className="portfolio-header"><a href="/" className="portfolio-brand" aria-label="ArTree Nepal home"><Image src="/images/site/artree-logo.png" alt="ArTree Nepal" width={68} height={68} /></a><a className="portfolio-back" href="/">← Back to collective</a></header>
