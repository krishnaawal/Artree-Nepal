...
export default async function ArtistPortfolio({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="portfolio-page">
      <header className="portfolio-header"><a href="/" className="portfolio-brand"><Image unoptimized src="/images/site/artree-logo.png" alt="ArTree Nepal" width={52} height={52} /><span>ArTree<br /><em>Nepal</em></span></a><a className="portfolio-back" href="/">← Back to collective</a></header>
